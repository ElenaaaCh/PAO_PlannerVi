...
Q_CONSTINIT static const qt_meta_stringdata_CLASSAula_ViewENDCLASS_t qt_meta_stringdata_CLASSAula_ViewENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 10),  // "viewClosed"
        QT_MOC_LITERAL(21, 0)   // ""
    },
    "Aula_View",
    "viewClosed",
...
void Aula_View::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Aula_View::*)() const;
            if (_t _q_method = &Aula_View::viewClosed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Aula_View::viewClosed()const
{
    QMetaObject::activate(const_cast< Aula_View *>(this), &staticMetaObject, 0, nullptr);
}
QT_WARNING_POP
